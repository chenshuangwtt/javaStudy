...
/**
 * BinaryOperator.maxBy and BinaryOperator.minBy BinaryOperator.maxBy accepts a
 * Compotator and returns BinaryOperator which will return maximum between two
 * elements. In the same way, BinaryOperator.minBy is used to get minimum
