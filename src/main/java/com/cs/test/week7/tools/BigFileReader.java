...
public class BigFileReader extends RecursiveTask<Item> {
	...
	public void start() {
		...
		cyclicBarrier = new CyclicBarrier(startEndPairs.size() + 1,
				new Runnable() {
			@Override
			public void run() {
	...
	public static class Builder {
		...
		public BigFileReader build() {
			return new BigFileReader(this.file, this.handle, 
					this.charset, this.bufferSize, this.threadSize);
		}
	}
